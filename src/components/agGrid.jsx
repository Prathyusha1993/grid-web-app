  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columnDefs: [
        ...
        { headerName: "SSN", field: "SSN", minWidth: 150, resizable: true },
        {
        ...
        { headerName: "Pathologist", field: "Pathologist", minWidth: 200 },
        {
          headerName: "Invoice FSC List",
          field: "Invoice_FSC_List",
          minWidth: 150,
        },
        { headerName: "Total Charges", field: "Total_Charges", minWidth: 150 },
        {
      ...
      detailCellRendererParams: {
        detailGridOptions: {
          columnDefs: [
            ...
            { headerName: "Txn Seq", field: "Txn_seq", minWidth: 100 },
            {
            ...
            { headerName: "CPT Code", field: "CPT_Code", minWidth: 150 },
            { headerName: "CDM Code", field: "CDM_Code", minWidth: 150 },
            {
              headerName: "CPT Desc",
            ...
            { headerName: "Charges", field: "Charges", minWidth: 150 },
            { headerName: "Payments", field: "Pay_Amount", minWidth: 150 },
            { headerName: "Adjust", field: "Adj_Amount", minWidth: 100 },
            { headerName: "Credit", field: "Credit_Amount", minWidth: 100 },
            { headerName: "FSC", field: "FSC_Mnemonic", minWidth: 100 },
            { headerName: "Batch#", field: "Batch_Num", minWidth: 100 },
            {
            ...
            },
            {
              ...
              valueGetter: function addColumns(params) {
                return (
                  params.data.LP_Pay_Code + " " + params.data.LP_Pay_Code_Desc
                );
              },
            },
            {
            ...
            { headerName: "LP Adjust", field: "LP_Adj_Amount", minWidth: 150 },
            {
